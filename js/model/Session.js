function Session(SERVER_PATH)
{
    ...
    Session.prototype.NAME = "rankingActivePlayer"; // the name of the session (String)
    // ===================================== Accessors =============================================
    // ------------------------------------------ Read accessors -----------------------------------
     ...
     * client, as long as the player transferred there in the database.
     * @author Sergio Baena López
     * @version 1.0
     * @param {Player object} player the player who wants to open session.
     ...
     */
    Session.prototype.open = function(player, beforeSendFunction, completeFunction)
    {
